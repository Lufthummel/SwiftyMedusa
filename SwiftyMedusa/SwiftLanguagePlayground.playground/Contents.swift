...
// Arrays
var shoppingList = ["App Cloud", "Sales Cloud", "Service Cloud", "Thunder"]
shoppingList[1] = "All of Salesforce"
...
occupations["Giordi la Forge"] = "Chief Engineer"
...
var secondForLoop = 0
/* C-Style loops have been removed in Swift3 !!!!!
 for var i = 0; i < 3; ++i {
 secondForLoop += 1
 }
*/

//-> as they should look now in Swift3 :-)
for i in 0 ..< 3 {
    secondForLoop += 1
}
secondForLoop
